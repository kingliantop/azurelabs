...
# - marathon
# - mesos agent
# - Updated by Steven Lian 2016/10/20 
# - China sources/JDK install/Mesos install/
###########################################################
set -x
...
installMesosDCOSCLI()
{
  ...
  sudo pip install -i http://pypi.douban.com/simple/ pyOpenSSL ndg-httpsclient pyasn1
  sudo pip install -i http://pypi.douban.com/simple/ virtualenv 
